...
create table estados (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, servouno TEXT, servodos TEXT, motor TEXT, led TEXT);
...
insert into estados (servouno, servodos, motor, led) values ('off', 'off', 'off', 'off');
